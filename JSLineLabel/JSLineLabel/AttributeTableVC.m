...
@interface AttributeTableVC ()
@property(nonatomic, strong)NSMutableArray *dataSource;

@end

@implementation AttributeTableVC
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    CGSize size = [JSAttributeLabel getLabelSizeWithText:str labelFont:UIFontSystem(14) lineSpace:5 maxWidth:js_screenW-20];
    return size.height;
}
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    JSAttributeLabel * attrLabel = [[JSAttributeLabel alloc] initWithFrame:CGRectZero labelFont:UIFontSystem(14) lineSpace:5 maxWidth:js_screenW-20];
